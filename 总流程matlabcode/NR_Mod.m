...
elseif(modutype == 3) %64QAM
    ...
    for(kkk=1:symbol_len)
        temp  = inputdata(8*kkk-7)*128+inputdata(8*kkk-6)*64 ...
            + inputdata(8*kkk-5)*32+inputdata(8*kkk-4)*16+inputdata(8*kkk-3)*8 ...
            + inputdata(8*kkk-2)*4+inputdata(8*kkk-1)*2 +inputdata(8*kkk)+1;
        out(kkk) = qam256(temp);
    end
